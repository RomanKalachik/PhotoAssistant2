...
const unsigned char* PreviewImage::getImagePtr(){
	return (previewImage->get_data());
}
int PreviewImage::getWidth() {
	return previewImage->get_width();
}
bool PreviewImage::IsValid() {
	return previewImage;
}
int PreviewImage::getHeight() {
	return previewImage->get_height();
}
int PreviewImage::getStride() {
	return previewImage->get_stride();
}
Cairo::Format PreviewImage::getPixelFormat() {
	return previewImage->get_format();
}