...
namespace PhotoAssistant.Controls.Wpf {
    public class PicturePrintControl : Control {
        static PicturePrintControl() => DefaultStyleKeyProperty.OverrideMetadata(typeof(PicturePrintControl), new FrameworkPropertyMetadata(typeof(PicturePrintControl)));
        ...
        public PrintQueue PrintQueue {
            get => (PrintQueue)GetValue(PrintQueueProperty);
        ...
        void OnPrintQueueChanged(DependencyPropertyChangedEventArgs e) {
            PrintTicket = GetPrintTicketFromPrinter();
            PrinterText = "Printer: " + PrintQueue.FullName;
        }
        public PrintTicket PrintTicket {
            get => (PrintTicket)GetValue(PrintTicketProperty);
        ...
        public static readonly DependencyProperty PageNumberTextProperty =
            DependencyProperty.Register("PageNumberText", typeof(string), typeof(PicturePrintControl), new PropertyMetadata(string.Empty));
        public string PaperText {
            get => (string)GetValue(PaperTextProperty);
            set => SetValue(PaperTextProperty, value);
        }
        public static readonly DependencyProperty PaperTextProperty =
            DependencyProperty.Register("PaperText", typeof(string), typeof(PicturePrintControl), new PropertyMetadata(string.Empty));
        public string PrinterText {
            get => (string)GetValue(PrinterTextProperty);
            set => SetValue(PrinterTextProperty, value);
        }
        public static readonly DependencyProperty PrinterTextProperty =
            DependencyProperty.Register("PrinterText", typeof(string), typeof(PicturePrintControl), new PropertyMetadata(string.Empty));
        public WatermarkParameters Watermark {
            get => (WatermarkParameters)GetValue(WatermarkProperty);
        ...
        void PicturePrintControl_Loaded(object sender, RoutedEventArgs e) => OnParamsChanged(new DependencyPropertyChangedEventArgs());
        ...
        public PicturePrintMovePrevCommand MovePrevCommand {
            get => (PicturePrintMovePrevCommand)GetValue(MovePrevCommandProperty);
        ...
        public PicturePrintMoveNextCommand MoveNextCommand {
            get => (PicturePrintMoveNextCommand)GetValue(MoveNextCommandProperty);
        ...
        void OnParamsChanged(DependencyPropertyChangedEventArgs e) => UpdatePagesParams();
        public List<PageInfo> ItemsSource {
            get => (List<PageInfo>)GetValue(ItemsSourceProperty);
        ...
        public PageLayoutCollection PageLayouts {
            get => (PageLayoutCollection)GetValue(PageLayoutsProperty);
        ...
        public double ScaleTransform => ((ScaleTransform)Border.RenderTransform).ScaleX;
        public PageLayoutTemplate PageLayout {
            get => (PageLayoutTemplate)GetValue(PageLayoutProperty);
        ...
        void OnPageLayoutChanged(DependencyPropertyChangedEventArgs e) => UpdatePages();
        public Style PictureBorderStyle {
            get => (Style)GetValue(PictureBorderStyleProperty);
        ...
        public double PageWidthPixels {
            get => (double)GetValue(PageWidthPixelsProperty);
        ...
        public double PageHeightPixels {
            get => (double)GetValue(PageHeightPixelsProperty);
        ...
        public Style BackgroundStyle {
            get => (Style)GetValue(BackgroundStyleProperty);
        ...
        public PageInfo SelectedPage {
            get => (PageInfo)GetValue(SelectedPageProperty);
        ...
        void OnSelectedPageChanged(DependencyPropertyChangedEventArgs e) {
            if(selectedPageChanged != null) {
                selectedPageChanged(this, EventArgs.Empty);
            }

            SelectedPhoto = SelectedPage.Files[SelectedPhotoLayout];
            PageNumberText = $"Page {SelectedPageIndex + 1} of {ItemsSource.Count}";
            LoadNearPhotos();
        }
        void LoadNearPhotos() {
        ...
        void LoadNearPhotos(PageInfo pageInfo) {
        ...
        public void Print() {
            ...
            try {
                System.Windows.Xps.XpsDocumentWriter xpsDocWriter = PrintQueue.CreateXpsDocumentWriter(pd.PrintQueue);
        ...
        void xpsDocWriter_WritingPrintTicketRequired(object sender, System.Windows.Documents.Serialization.WritingPrintTicketRequiredEventArgs e) => e.CurrentPrintTicket = PrintTicket;
        DocumentReference toDocumentReference(UIElement uiElement) {
            if(uiElement == null) {
        ...
        public void PrintSinglePage() {
            ...
            try {
                ...
                pd.PrintVisual(pg, string.Empty);
            } catch(Exception) { }
        }
        PrintTicket GetPrintTicketFromPrinter() {
        ...
        PhotoInfo CreatePhotoInfo(PageInfo pageInfo, PhotoLayoutTemplate photoLayout, DmFile dmFile) => new PhotoInfo() { PageInfo = pageInfo, File = dmFile, PhotoLayout = photoLayout };
        int GetFilesPerPage() {
        ...
        public int SelectedPhotoLayout {
            get => (int)GetValue(SelectedPhotoLayoutProperty);
        ...
        void OnSelectedPhotoLayoutChanged(DependencyPropertyChangedEventArgs e) {
            if(PageControl != null) {
                SelectedPhoto = SelectedPage.Files[SelectedPhotoLayout];
            }
        ...
        public event EventHandler SelectedPhotoLayoutChanged {
            add {
                selectedPhotoLayoutChanged += value;
            }
            remove {
                selectedPhotoLayoutChanged -= value;
            }
        ...
        void OnSelectedPhotoChanged(PhotoInfo prev) {
            if(prev != null) {
                prev.Selected = false;
            }
    ...
    public class PrintablePageControl : PageControl {
        static PrintablePageControl() => DefaultStyleKeyProperty.OverrideMetadata(typeof(PrintablePageControl), new FrameworkPropertyMetadata(typeof(PrintablePageControl)));
    }
    public class PageControl : ItemsControl {
        static PageControl() => DefaultStyleKeyProperty.OverrideMetadata(typeof(PageControl), new FrameworkPropertyMetadata(typeof(PageControl)));
        public PageControl() => Loaded += PageControl_Loaded;
        public PicturePrintControl PrintControl {
            get => (PicturePrintControl)GetValue(PrintControlProperty);
        ...
        void OnPageInfoChanged(DependencyPropertyChangedEventArgs e) {
            if(PageInfo == null) {
                ItemsSource = null;
                return;
            }
    ...
    public class PhotoInfo : DependencyObject {
        ...
        public static readonly DependencyProperty LabelTextProperty =
            DependencyProperty.Register("LabelText", typeof(string), typeof(PhotoInfo), new PropertyMetadata(string.Empty));
        public string PhotoInfoText {
            get => (string)GetValue(PhotoInfoTextProperty);
            set => SetValue(PhotoInfoTextProperty, value);
        }
        public static readonly DependencyProperty PhotoInfoTextProperty =
            DependencyProperty.Register("PhotoInfoText", typeof(string), typeof(PhotoInfo), new PropertyMetadata(string.Empty));
        public DmFile File {
            get => (DmFile)GetValue(FileProperty);
    ...
    public class PageInfo : DependencyObject {
        public List<PhotoInfo> Files {
            get => (List<PhotoInfo>)GetValue(FilesProperty);
    ...
    public class PhotoLayoutTemplate : DependencyObject {
        public double LabelPadding {
            get => (double)GetValue(LabelPaddingProperty);
        ...
        void OnLabelPaddingChanged(DependencyPropertyChangedEventArgs e) {
        ...
        public double LabelPaddingPixels {
            get => (double)GetValue(LabelPaddingPixelsProperty);
        ...
        public ItemPosition LabelPosition {
            get => (ItemPosition)GetValue(LabelPositionProperty);
        ...
        void OnLabelPositionChanged(DependencyPropertyChangedEventArgs e) {
        ...
        public bool ShowPhotoInfo {
            get => (bool)GetValue(ShowPhotoInfoProperty);
        ...
        public Color LabelBorderColor {
            get => (Color)GetValue(LabelBorderColorProperty);
        ...
        void OnLabelVerticalAlignmentChanged(DependencyPropertyChangedEventArgs e) {
            if(LabelVerticalAlignment == VerticalAlignment.Center || LabelVerticalAlignment == VerticalAlignment.Stretch) {
        ...
        public Stretch ImageFit {
            get => (Stretch)GetValue(ImageFitProperty);
    ...
    public class PageLayoutTemplate : DependencyObject {
        public PageLayoutTemplate() => PhotoLayouts = new PhotoInfoCollection();
        public PicturePrintControl PrintControl {
            get => (PicturePrintControl)GetValue(PrintControlProperty);
            set => SetValue(PrintControlProperty, value);
        }
        ...
        void OnPrintCotrolChanged(DependencyPropertyChangedEventArgs e) => UpdateParamsByDpi();
        public Style PictureBorderStyle {
            get => (Style)GetValue(PictureBorderStyleProperty);
            set => SetValue(PictureBorderStyleProperty, value);
        }
        ...
        public Style PageBackgroundStyle {
            get => (Style)GetValue(PageBackgroundStyleProperty);
        ...
        public Thickness PageMargins {
            get => (Thickness)GetValue(PageMarginsProperty);
        ...
        void UpdateParamsByDpi() {
            ...
            PageMarginsPixels = new Thickness(PageMargins.Left * PrintControl.Dpi.Width, PageMargins.Top * PrintControl.Dpi.Height, PageMargins.Right * PrintControl.Dpi.Width, PageMargins.Bottom * PrintControl.Dpi.Height);
            ImageIndentPixels = ImageIndent * PrintControl.Dpi.Width;
        }
        void OnPageMarginsChanged(DependencyPropertyChangedEventArgs e) => UpdateParamsByDpi();
        public Thickness PageMarginsPixels {
            get => (Thickness)GetValue(PageMarginsPixelsProperty);
        ...
        public double ImageIndent {
            get => (double)GetValue(ImageIndentProperty);
        ...
        void OnImageIndentChanged(DependencyPropertyChangedEventArgs e) => UpdateParamsByDpi();
        public double ImageIndentPixels {
            get => (double)GetValue(ImageIndentPixelsProperty);
        ...
        public static readonly DependencyProperty NameProperty =
            DependencyProperty.Register("Name", typeof(string), typeof(PageLayoutTemplate), new PropertyMetadata(string.Empty));
        public string Description {
            get => (string)GetValue(DescriptionProperty);
            set => SetValue(DescriptionProperty, value);
        }
        public static readonly DependencyProperty DescriptionProperty =
            DependencyProperty.Register("Description", typeof(string), typeof(PageLayoutTemplate), new PropertyMetadata(string.Empty));
        ...
        public PhotoInfoCollection PhotoLayouts {
            get => (PhotoInfoCollection)GetValue(PhotoLayoutsProperty);
        ...
        public void ResetParams() => copyLayout = null;
    ...
    public class PicturePrintCommandBase : ICommand {
        public PicturePrintCommandBase(PicturePrintControl owner) => Owner = owner;
        protected PicturePrintControl Owner {
            get; private set;
        }
        bool ICommand.CanExecute(object parameter) => CanExecuteCore(parameter);
        protected virtual bool CanExecuteCore(object parameter) => false;
        ...
        void ICommand.Execute(object parameter) => ExecuteCore(parameter);
        protected virtual void ExecuteCore(object parameter) {
        }
        protected void RaiseExecuteChangedCore() => Owner.RaiseCommandExecuteChanged();
    }
    ...
    public class PhotoPaginator : DocumentPaginator, IDocumentPaginatorSource {
        public PhotoPaginator(PicturePrintControl control) => Control = control;
        public PicturePrintControl Control {
            get; private set;
        }
        public override Size PageSize {
            get => new Size(Control.PrintTicket.PageMediaSize.Width.Value, Control.PrintTicket.PageMediaSize.Height.Value);
            set {
            }
        }
        public override bool IsPageCountValid => true;
        public override IDocumentPaginatorSource Source => this;
        public override int PageCount => Control.ItemsSource.Count;
