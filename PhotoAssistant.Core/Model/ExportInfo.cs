...
namespace PhotoAssistant.Core.Model {
    ...
    public class ExportInfo {
        public ExportInfo() => Watermark = new WatermarkParameters();
        ...
        [XtraSerializableProperty]
        public ExistingFileMode ExistingFileMode {
            get; set;
        }
        [XtraSerializableProperty]
        ...
        [XtraSerializableProperty]
        public ImageDimensionMode ImageDimension {
            get; set;
        }
        [XtraSerializableProperty]
        ...
        [XtraSerializableProperty]
        public AfterExportEvent AfterExportEvent {
            get; set;
        }
        string applicationIdString;
        [XtraSerializableProperty]
        public string ApplicationIdString {
            get => applicationIdString;
            set {
        ...
        public int PngBitsPerChannel {
            get => bitsPerChannel;
            set => bitsPerChannel = ConstrainBitsPerChannel(value);
        }
    ...
    public class ExportNodeInfo {
        public ExportNodeInfo() => Id = Guid.NewGuid();
        string name;
        public string Name {
            get {
                if(ExportInfo != null) {
