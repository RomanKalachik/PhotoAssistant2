...
namespace PhotoAssistant.Core.Model {
    ...
    public class DmTagNode {
        public DmTagNode() => Id = Guid.NewGuid();
        ...
        [NotMapped]
        public string Text => Tag.Value;
        public virtual ICollection<DmTagNode> Children {
            get; set;
        }
    ...
    public class DmTagNodeReversed {
        public DmTagNodeReversed() => Id = Guid.NewGuid();
        ...
        public virtual ICollection<DmTagNodeReversed> Children {
            get; set;
        }
    ...
    public class DmKeyword : IDmKeyword, ISupportId {
        public DmKeyword() => Id = Guid.NewGuid();
        ...
        public virtual DmFile File {
            get; set;
        }
        public virtual DmTag Tag {
            get; set;
        }
        public TagType Type => TagType.Tag;
        [NotMapped]
        public object RemovedTag {
            get; set;
        }
    }
    public class DmPeople : IDmKeyword, ISupportId {
        public DmPeople() => Id = Guid.NewGuid();
        ...
        public TagType Type => TagType.People;
        [NotMapped]
        public object RemovedTag {
            get; set;
        }
    ...
    public class DmCategory : IDmKeyword, ISupportId {
        public DmCategory() => Id = Guid.NewGuid();
        ...
        public TagType Type => TagType.Category;
        [NotMapped]
        public object RemovedTag {
            get; set;
        }
    ...
    public class DmGenre : IDmKeyword, ISupportId {
        public DmGenre() => Id = Guid.NewGuid();
        ...
        public TagType Type => TagType.Genre;
        [NotMapped]
        public object RemovedTag {
            get; set;
        }
    ...
    public class DmAutor : IDmKeyword, ISupportId {
        public DmAutor() => Id = Guid.NewGuid();
        ...
        public TagType Type => TagType.Autor;
        [NotMapped]
        public object RemovedTag {
            get; set;
        }
    ...
    public class DmCollection : IDmKeyword, ISupportId {
        public DmCollection() => Id = Guid.NewGuid();
        ...
        public TagType Type => TagType.Collection;
        [NotMapped]
        public object RemovedTag {
            get; set;
        }
    ...
    public enum TagType {
        Tag, People, Category, Genre, Autor, Collection
    }
