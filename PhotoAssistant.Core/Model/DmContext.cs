...
namespace PhotoAssistant.Core.Model {
    class DbContextConfiguration : DbConfiguration {
        ...
        static System.Data.Entity.Core.Common.DbProviderServices GetProviderServices() => (System.Data.Entity.Core.Common.DbProviderServices)
                    System.Data.SQLite.EF6.SQLiteProviderFactory.Instance.GetService(typeof(System.Data.Entity.Core.Common.DbProviderServices));
    }
    ...
    public class DmContext : DbContext {
        ...
        public DbSet<DmFile> Files {
            get; set;
        }
        public DbSet<Filter> Filters {
            get; set;
        }
        public DbSet<DmPeople> Peoples {
            get; set;
        }
        public DbSet<DmKeyword> Keywords {
            get; set;
        }
        public DbSet<DmCategory> Categories {
            get; set;
        }
        public DbSet<DmCollection> Collections {
            get; set;
        }
        public DbSet<DmGenre> Genres {
            get; set;
        }
        public DbSet<DmAutor> Autors {
            get; set;
        }
        public DbSet<DmColorLabel> ColorLabels {
            get; set;
        }
        public DbSet<MediaFormat> MediaFormat {
            get; set;
        }
        public DbSet<DbPropertiesModel> Properties {
            get; set;
        }
        public DbSet<DmStorageVolume> Volumes {
            get; set;
        }
        public DbSet<DmTag> Tags {
            get; set;
        }
        public DbSet<DmTagNode> TagNodes {
            get; set;
        }
        public DbSet<DmTagNodeReversed> TagNodesReversed {
            get; set;
        }
