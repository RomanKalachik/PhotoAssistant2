...
namespace PaintDotNet.PropertySystem {
    ...
    public abstract class CustomTypeDescriptorBase
 : ICustomTypeDescriptor {
    ...
    public abstract class Property : CustomPropertyDescriptor, ICloneable<Property> {
        ...
        public override void SetValue(object component, object val) { Value = val; }
